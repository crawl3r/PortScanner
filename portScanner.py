...
def get_range_of_ports():
	Prange = input("port range to scan - e.g, 1-10: ")
...
def get_common_ports():
	print("Scanning the commonly used ports")
...
def scan_target_IP(ipAddress, ports):
	print("Scanning target: ", ipAddress)
...
def main():
	...
	if choice == 1:
		...
		print("Enter the IP addresses to scan between, seperated by a '-'")
